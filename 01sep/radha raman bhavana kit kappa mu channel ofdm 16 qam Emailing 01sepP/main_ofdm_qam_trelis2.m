...
for d=1:dmax
    ...
    j=s1/k;
    if xx==1
        codedata=data;%bipass trellis
        interleaveddata=interleaver([codedata,zeros(1,100)]);%interleaver
    ...
    for snr1=0:2:50
        ...
        if kmuuse==0
            ...
            syncheddata=ffsignal;% synch data stream using pilot 
        end
        snr1
        if kmuuse==1
            kappa=.5;
        ...
        if xx==1
%             rtemp=viterbidecoder(rx2,trellis);
